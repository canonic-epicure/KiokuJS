        ...
        collapse : function (instance, node, collapser) {
            ...
            var scanAttributes = function (attribute, name) {
                ...
                if (attribute instanceof Joose.Managed.Property.Attribute)
                    ...
                    var attrMeta = attribute.meta
                    
                    if ((attrMeta instanceof Joose.Managed.Attribute) && attrMeta.does(KiokuJS.Meta.Aspect.AfterCollapse)) attribute.afterCollapse(instance, data[ name ], node)
            ...
            if ((meta instanceof Joose.Managed.Class) && meta.does(KiokuJS.Meta.Aspect.AfterCollapse)) meta.afterCollapse(instance, node)
