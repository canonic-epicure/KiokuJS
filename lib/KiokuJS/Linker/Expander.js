Class('KiokuJS.Linker.Expander', {
    ...
    methods : {
        ...
        visitNode : function (node) {
            ...
            var oldNode = scope.parent && scope.parent.idToNode(node.ID)
            
            if (oldNode) {
                node.object = oldNode.object
                
                node.clearInstance()
            } else {
                // newly created instance need to have the __REF_ADR__ as this property
