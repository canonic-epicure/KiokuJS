    ...
    continued : {
        ...
        methods : {
            ...
            materialize : function (ids) {
                ...
                backend.get(ids).andThen(function (firstClassNodes) {
                    ...
                    // with extra nodes)
                    var newNodesData        = Joose.A.map(firstClassNodes, function (firstClassNode) {
                        var node = me.pinNode(firstClassNode)
                        
                        if (node) return node.data
                    })
                    
                    Joose.A.each(backend.gatherReferences(newNodesData), function (refID) {
