...
//                this.objectsByID[ nodeID ] = object
            } else
...
//                delete this.objectsByREFADR[ REFADR ]
            } else
        ...
        // XXX not tested
        includeNewObjects : function (objectsWithIDs, objectsWithOutIDs) {
            var nodes   = this.collapse(objectsWithIDs, objectsWithOutIDs, { isShallow : true })
            
            Joose.A.each(nodes, this.pinNode, this)
            
            var customIDs = {}
            
            Joose.O.each(objectsWithIDs, function (object, id) {
                customIDs[ id ] = true
            })
