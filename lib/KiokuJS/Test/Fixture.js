Class('KiokuJS.Test.Fixture', {
    ...
    methods : {
        ...
        checkSkipReason : function (handle) {
            ...
            if (!handleAllRequiredRoles) return "Backend [" + backend + "] don't implement the role [" + notImplementedRole.meta.name + "], required for fixture [" + this + "]"
        }
        ...
        methods : {
            ...
            run : function () {
                ...
                this.TRY(function () {
                    ...
                    this.populate(handle, t).then(function () {
                        
                        this.verify(handle, t).then(function () {
