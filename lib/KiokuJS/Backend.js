Class('KiokuJS.Backend', {
    ...
    use     : [ 
        ...
        'KiokuJS.Collapser.Decoder', 
        'KiokuJS.Linker.Gatherer', 
        'KiokuJS.Node' 
    ],
...
//            entries             = this.decodeEntries(encodedEntries)
//            
//            var me              = this
//            
//            return Joose.A.map(entries, function (entry) {
//                
//                if (entry) return me.createNodeFromEntry(entry)
//            })
        },
        
        
//        serializeNodesWithIDs : function (nodes) {
//            var stringifiedNodes  = this.serializeNodes(nodes)
//            
//            return Joose.A.map(nodes, function (node, index) {
//                
//                return {
//                    ID      : node.ID,
//                    entry   : stringifiedNodes[ index ]
//                }
//            })
//        },
